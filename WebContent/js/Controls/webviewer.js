 ...
 */
var stageheight,overlay,canvas,imagearray,textOverlay,intervel,intervelback,intervelnxt, imgindex=0,imageChange,stagewidth,leftview,canvasImgdata,nativerow=512,nativecoloum=512,diffrentHeight, addEventInArray,loadPixel;
var timer;
var bottomval=400;
var currentzoom=1;
var dragtool=false;
...
//             cxt.putImageData(canvasData, 0, 0); 
    ...
    $("#imgSlider").change(function(event) {
        ...
        if(tagData[0]['numberofframes']=="Empty" ){
            ...
            var ww=tagData[imgindex]['windowWidth'].split("|");
            $("#wlwcoly").html("WC:"+wc[0]+":"+"WW:"+ww[0]);
            $("#resolution").html("Matrix:"+""+nativerow+"x"+nativecoloum);       
            loadImage(imagearray[imgindex]);
        }
        else{
